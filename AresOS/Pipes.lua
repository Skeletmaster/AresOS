...
function self:setScreen()
    ...
    svgOut = svgOut .. "<text x=\"" .. 1.65 + 0.5 .. "%\" y=\"" .. 65.65 + 2 .. "%\" style=\"fill:#FFFFFF\">Pipe " .. np_name .. "</text>"
    ...
    svgOut = svgOut .. "<text x=\"" .. 1.65 + 0.5 .. "%\" y=\"" .. 65.65 + 4 .. "%\" style=\"fill:#FFFFFF\">Safezone " .. sz_name .. "</text>"
