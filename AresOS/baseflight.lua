...
function self:register(env)
    ...
    settings:add("ToggleBreak",false,"","Break Toggle (on/off)")
    ...
    register:addAction("brakeStart", "brakeStartFlight",  function() if settings:get("ToggleBreak") then if brakeInput == 1 then brakeInput = 0 else brakeInput = 1 end else brakeInput = 1 end end)
    ...
    register:addAction("brakeStop", "brakeStopFlight", function() if settings:get("ToggleBreak") then else brakeInput = 0 end end)
